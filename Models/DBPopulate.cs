        ...
        public static void EnsurePopulateDB(IApplicationBuilder app)
        {
            ...
            if (!context.parties.Any())
            {
                List<Party> parties = new List<Party> 
                {
                    ...
                    new Party { Name = "Martyn Gey party", Description = "Description for this party", PartyStatus = "PRIVATE", CreationDate = DateTime.Now, CreatorID = "Torphik", DrawDate = DateTime.Now }
                };
